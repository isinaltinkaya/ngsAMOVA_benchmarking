...
jgcdf<-"/home/isin/Mount/AMOVA/simulations/msprime/simulations/sim_demes_v2/model_model1/contig_1/genotype_likelihood/ngsAMOVA_maxIter500_tole5/sim_demes_v2-model1-1-rep0-d1.joint_geno_count_dist.csv.bgz"
zz=gzfile(jgcdf,'rt')
d=read.csv(zz,header=F)
