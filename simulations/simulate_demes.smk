...
rule collect_results_gle_230205:
	input: 
		expand("simulations/{simid}/model_{model_id}/contig_{contig}/gle_doAmova1/{simid}-{model_id}-{contig}-rep{rep}-d{depth}_tole{tole}.amova.csv",
			...
			tole=5),
	output:
		vc="simulations/sim_demes_v2/collected_results/collect_feb23/sim_demes_v2_doAmova2_gle_tole5_amova_varianceComponent.csv",
		phi="simulations/sim_demes_v2/collected_results/collect_feb23/sim_demes_v2_doAmova2_gle_tole5_amova_phi.csv",
	shell:
		"""
